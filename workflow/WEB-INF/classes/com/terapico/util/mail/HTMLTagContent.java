...
public class HTMLTagContent {
	...
	public boolean isImage(){
		return this.name.equals("img")&&this.getProperty("src")!=null;
		
	}
	public boolean hasImage(){
		return (this.name.equals("input")
				||this.name.equals("img"))&&this.getProperty("src")!=null;
		
	}
	public boolean hasDocument(){
		return this.name.equals("doc")&&this.getProperty("src")!=null;
	}
	public boolean hasExternalResource(){
		return (this.name.equals("input")
				||this.name.equals("img")
				||this.name.equals("script"))
				&&this.getProperty("src")!=null;
		
	}
	public boolean isHyperLinkArea(){
		return this.name.equals("a")&&this.getProperty("href")!=null;		
	}
	public boolean isLink(){
		return (this.name.equals("link")
				||this.name.equals("a"))
				&&this.getProperty("href")!=null;		
	}
